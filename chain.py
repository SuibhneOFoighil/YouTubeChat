...
def get_interpreter_chain(llm):
    template = """You are reformatting and citing the answers of a Question-Answer Model. Use the Context to find where in the Answer to put the Citations. If the Context does not know, do not write "N/A" but use full sentences. Follow the example below:
